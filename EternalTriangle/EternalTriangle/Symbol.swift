...
//  EternalTriangle
//
//  Created by hokada on 9/17/15.
//  Copyright (c) 2015 Haruki Okada. All rights reserved.
//

import Foundation

@IBDesignable public class SymbolFour: SheetElement {
...
@IBDesignable public class SymbolTwo: SheetElement {
  public override func drawRect(rect: CGRect) {
    let (w, h) = size
...
@IBDesignable public class SymbolC: SheetElement {
  public override func drawRect(rect: CGRect) {
    let (w, h) = size
