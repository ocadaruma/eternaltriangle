...
//  EternalTriangle
//
//  Created by hokada on 9/18/15.
//  Copyright (c) 2015 Haruki Okada. All rights reserved.
//

import Foundation

@IBDesignable public class Flat: SheetElement {
...
@IBDesignable public class DoubleFlat: SheetElement {
  public override func drawRect(rect: CGRect) {
    let (width, h) = size
    let w = width / 2
    let x = w
...
@IBDesignable public class Sharp: SheetElement {
  public override func drawRect(rect: CGRect) {
    let (w, h) = size
...
@IBDesignable public class DoubleSharp: SheetElement {
  public override func drawRect(rect: CGRect) {
    let ctx = UIGraphicsGetCurrentContext()
...
@IBDesignable public class Natural: SheetElement {
  public override func drawRect(rect: CGRect) {
    let (w, h) = size
